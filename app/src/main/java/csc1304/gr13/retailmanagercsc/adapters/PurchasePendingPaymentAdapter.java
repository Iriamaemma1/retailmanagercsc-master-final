...
public class PurchasePendingPaymentAdapter extends RecyclerView.Adapter<PurchasePendingPaymentAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
       ...
       // purchases.set(position,pModel);
        ...
        String purchase_balance = purchases.get(position).getPurchase_balance();
        String purchase_date = purchases.get(position).getPurchase_date();
        Log.e("purchase_qty",purchase_qty);
        Log.e("unit_purchase_price",purchase_balance);

        holder.purchase_qty.setText( ""+purchase_qty+" Units");
        holder.unit_price.setText(""+purchase_balance+" UGX");
    ...
    public PurchasePendingPaymentAdapter(@NonNull Context context, @NonNull ArrayList<PurchaseModel> objects) {
