...
public class AddStockActivity extends FragmentActivity implements MenuFragment.OnTransactionItemClickListener {
    ...
    private AddStockMenuFragment addStockMenuFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addStockMenuFragment = new AddStockMenuFragment();
        tranTitle = findViewById(R.id.trans_name);
        tranTitle.setText("ADD STOCK");
        this.mViewPager = findViewById(R.id.idtype_menu_pager);
        this.fragmentList.add(addStockMenuFragment);
    ...
    private void startTimeTask() {
        ...
        new Thread() {
            public void run() {
                while (!AddStockActivity.this.isEndTimeout) {
                    if (System.currentTimeMillis() - AddStockActivity.this.startTime > ((long) (AddStockActivity.this.timeout * 1000))) {
