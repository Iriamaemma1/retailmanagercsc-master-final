...
import csc1304.gr13.retailmanagercsc.adapters.PurchasePendingPaymentAdapter;
 ...
 */
public class PurchasePendingPaymentFrg extends Fragment {


    public PurchasePendingPaymentFrg() {
    ...
    private View view;
    private PurchasePendingPaymentAdapter adapter;
...
//                ,new IntentFilter("updateDatabaseStatus"));
    ...
    private void listViewUpdate() {
        try {
            allPurchases = purchase.getAllPendingPurchasePayments();
        }catch (Exception e){
            e.printStackTrace();
        }
        adapter = new PurchasePendingPaymentAdapter(Objects.requireNonNull(getActivity()),allPurchases);
