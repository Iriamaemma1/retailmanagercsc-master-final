...
public class SmartPost {
	...
	public static byte[] InitMessage(byte[] cmd, byte path, BigDecimal amount,
		...
		try {
			...
			baos.write(csc1304.gr13.retailmanagercsc.p25.pockdata.Function.toHex2Len(len));
			...
			byte LRC = csc1304.gr13.retailmanagercsc.p25.pockdata.Function.Enteryparity(LRCContent);
