...
public class PrintSellInfo {
    ...
    public String getPaidWithTv() {
        return paidWithTv;
    }

    public void setPaidWithTv(String paidWithTv) {
        this.paidWithTv = paidWithTv;
    }
}
