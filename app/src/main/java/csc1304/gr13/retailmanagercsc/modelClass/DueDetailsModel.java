...
public class DueDetailsModel {
    ...
    public DueDetailsModel(int dueid,String name, String phone, String email, String type, String totalAmount, String paid, String date, String due, String customerId) {
        this.dueid = dueid;
        this.name = name;
        this.phone = phone;
        this.email = email;
