...
public class ProductListModel implements Serializable{
    ...
    public ProductListModel(String pId,String pPrice, String pName, String pBrand, String pSize, String pUnit, String pStock,String pCode) {
        this.pId = pId;
        this.pPrice = pPrice;
        this.pName = pName;
        this.pBrand = pBrand;
    ...
    public String getpVariation() {
        return pVariation;
    }

    public void setpVariation(String pVariation) {
